<?php
     ...
     $sub_title = isset($query_obj->name) ? $query_obj->name : $options['archive_blog_sub_title'];
     $desc = isset($query_obj->description) ? $query_obj->description : $options['archive_interview_desc'];
...
<?php if ($options['archive_blog_show_category_list'] == 'display' ) {
 ...
 <div class="blog_list">
  ...
  <div class="item">
   <?php
        $cat_url = get_term_link($current_cat_id,'category');
