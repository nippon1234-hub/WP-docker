<?php
     ...
     if(is_tag()) {
       ...
       $sub_title = sprintf( __( 'Archive for %s', 'tcd-issue' ), get_the_time( __( 'F jS, Y', 'tcd-issue' ) ) );
       $desc = '';
       $desc_mobile = '';
     } elseif ( is_month() ) {
       $sub_title = sprintf( __( 'Archive for %s', 'tcd-issue' ), get_the_time( __( 'F, Y', 'tcd-issue') ) );
       $desc = '';
       $desc_mobile = '';
     } elseif ( is_year() ) {
       $sub_title = sprintf( __( 'Archive for %s', 'tcd-issue' ), get_the_time( __( 'Y', 'tcd-issue') ) );
       $desc = '';
       $desc_mobile = '';
     }
?>
