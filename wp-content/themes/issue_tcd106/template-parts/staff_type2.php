...
<article id="staff_content_type2">
   ...
   <div id="staff_image_carousel" class="swiper-wrapper">
    ...
    <?php
         foreach( $images as $image_id ):
           ...
           $image_sp = wp_get_attachment_image_src( $image_id, 'size2' );
           if($image){
    ?>
    <div class="item swiper-slide">
     <picture class="image">
 ...
 <div id="staff_main_content">
  ...
  <div class="link_button">
   <a class="design_button" href="<?php echo esc_url(get_post_type_archive_link('staff')); ?>"><?php printf(__('Back to %s list', 'tcd-issue'), $staff_label); ?></a>
  </div>
...
<div class="staff_carousel">
 ...
 <div class="staff_carousel_wrap_type2">
  <div class="staff_carousel_type2_<?php echo $i; ?> swiper">
   <div class="staff_list_type2 swiper-wrapper">
    ...
    <a class="item animate_background swiper-slide" href="<?php the_permalink(); ?>">
     <picture class="image_wrap staff_list_image">
      <source media="(max-width: 650px)" srcset="<?php echo esc_attr($image_sp[0]); ?>">
