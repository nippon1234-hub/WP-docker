...
<section id="archive_interview">
 ...
 <div id="interview_category_sort_<?php echo esc_attr($options['interview_category_type']); ?>_wrap">
  <div id="interview_category_sort_<?php echo esc_attr($options['interview_category_type']); ?>" class="swiper<?php if( ($options['interview_category_type'] == 'type1' && $total < 3) || ($options['interview_category_type'] == 'type2' && $total < 4) ){ echo ' small_size'; }; ?>">
   <div class="interview_category_sort_button swiper-wrapper">
    <?php
         ...
         foreach ( $category as $cat ) :
           $cat_id = $cat->term_id;
    ?>
    <div class="item swiper-slide<?php if($i == 1){ echo ' active_menu'; }; ?>">
 ...
 <div id="interview_list_wrap">
  ...
  <div class="ajax_post_list_wrap interview_content active" id="ajax_post_cat_all">
  ...
  <?php
         ...
         foreach ( $category as $cat ) :
           $cat_id = $cat->term_id;
  ?>
  <div class="ajax_post_list_wrap interview_content<?php if($category_count == 1){ echo ' active'; }; ?>" id="ajax_post_cat_<?php echo esc_attr($cat_id); ?>">
