...
// カテゴリー編集用入力欄を出力 -------------------------------------------------------
function staff_category_edit_extra_fields( $term ) {
...
add_action( 'staff_category_edit_form_fields', 'staff_category_edit_extra_fields' );



// データを保存 -------------------------------------------------------
function staff_category_save_extra_fileds( $term_id ) {
  $new_meta = array();
...
add_action( 'edited_staff_category', 'staff_category_save_extra_fileds' );
