...
function custom_quick_edit( $column_name, $post_type ) {
  ...
  if ( $print_nonce ) {
    ...
    // seo
    if ( in_array( $post_type, array( 'post', 'page', 'news', 'staff', 'interview' ) ) ) {
  ...
  <div class="inline-edit-col column-meta-seo">
    <div class="inline-edit-group">
      <label class="inline-edit-tcd-w_meta_title">
        <span class="title"><?php _e('Title tag', 'tcd-issue'); ?></span>
      ...
      <label class="inline-edit-tcd-w_meta_description">
        <span class="title" style="line-height:1.5;"><?php _e('Meta description tag', 'tcd-issue');  ?></span>
...
<fieldset class="inline-edit-col-right">
  <div class="inline-edit-col column-recommend">
    <div class="inline-edit-group">
      <label style="line-height:1.5;"><input type="checkbox" name="recommend_post" value="on" /> <?php _e( 'Show this post for recommend post1', 'tcd-issue' );  ?></label>
      <label style="line-height:1.5;"><input type="checkbox" name="recommend_post2" value="on" /> <?php _e( 'Show this post for recommend post2', 'tcd-issue' );  ?></label>
      <label style="line-height:1.5;"><input type="checkbox" name="recommend_post3" value="on" /> <?php _e( 'Show this post for recommend post3', 'tcd-issue' );  ?></label>
    </div>
  </div>
</fieldset>
<?php
...
<?php
    ...
    // recommend staff
    if ( $post_type == 'staff' ) {
      echo '<input type="hidden" name="recommend_staff_meta_box_nonce" value="', wp_create_nonce( 'recommend_staff.php' ), '" />';
?>
<fieldset class="inline-edit-col-right">
  <div class="inline-edit-col column-recommend">
    <div class="inline-edit-group">
...
<?php
    ...
    if ( $post_type == 'interview' ) {
      echo '<input type="hidden" name="recommend_interview_meta_box_nonce" value="', wp_create_nonce( 'recommend_interview.php' ), '" />';
?>
<fieldset class="inline-edit-col-right">
  <div class="inline-edit-col column-recommend">
    <div class="inline-edit-group">
