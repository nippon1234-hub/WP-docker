...
<div class="custom_category_meta" style="margin:20px 0;">
 <h3 class="ccm_headline"><?php _e( 'Additional user data', 'tcd-issue' ); ?></h3>

 <div class="ccm_content clearfix">

  <ul class="option_list" style="margin-bottom:30px;">
   <?php
        // 寄稿者以上
   ...
   <li class="cf">
    <span class="label">TikTok URL</span>
   ...
   <li class="cf">
    <span class="label">Pinterest URL</span>
   ...
   <li class="cf">
    <span class="label"><?php _e('Contact page URL<br>(You can use mailto:)', 'tcd-issue'); ?></span>
   ...
   <li class="cf">
    <span class="label">
     <?php _e('Profile image', 'tcd-issue'); ?>
     <span class="recommend_desc"><?php printf(__('Recommend image size. Width:%1$spx, Height:%2$spx.', 'tcd-issue'), '300', '300'); ?></span>
    </span>
